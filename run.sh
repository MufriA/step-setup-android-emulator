echo $WERCKER_SETUP_ANDROID_EMULATOR_PORT
...
emulator -avd $WERCKER_SETUP_ANDROID_EMULATOR_TARGET_NAME -no-skin -no-audio -no-window -port $WERCKER_SETUP_ANDROID_EMULATOR_PORT &
